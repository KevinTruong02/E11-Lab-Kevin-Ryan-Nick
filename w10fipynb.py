...
Original file is located at
    https://colab.research.google.com/drive/1Dt2SQ5Gh3BewdjcDZ56TcRYk4QslpeHJ
"""
...
parser.add_argument('--output', type=str, default='radiation_counts.csv', help='Filename for saving the output in CSV format.')
